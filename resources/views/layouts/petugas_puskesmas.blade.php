            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="./index.html" class="text-nowrap logo-img">
                        <img src="{{ asset('layout/src/assets/images/logos/logo.png') }}" width="180"
                            alt="" />
                    </a>
                </div>
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        <li class="sidebar-item {{ request()->routeIs('petugas-puskesmas.dashboard') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('petugas-puskesmas.dashboard') }}"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('petugas-puskesmas.manajemen-user') }}"
                                aria-expanded="false">
                                <span><i class="fas fa-home"></i></span>
                        ...
                        <li
                            class="sidebar-item {{ request()->routeIs('petugas-puskesmas.daftar-balita*') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('petugas-puskesmas.daftar-balita') }}">
                                <span><i class="fas fa-user"></i></span>
                                <span class="hide-menu">Daftar Balita</span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('petugas-puskesmas.laporan-pengukuran') }}"
                                aria-expanded="false">
                                <span><i class="icon-chart"></i></span>
                                <span class="hide-menu">Laporan Pengukuran</span>
                            </a>
                        </li>

                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{ route('petugas-puskesmas.laporan-screening') }}"
                                aria-expanded="false">
                                <span><i class="fas fa-clipboard"></i></span>
                                <span class="hide-menu">Laporan Screening</span>
                            </a>
                        </li>
                    </ul>
                </nav>
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('petugas-puskesmas.dashboard') }}">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2"
                                ...
                                <img src="{{ asset('layout/src/assets/images/profile/user-1.jpg') }}" alt=""
